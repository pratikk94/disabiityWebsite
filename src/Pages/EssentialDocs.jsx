      ...
      <center>
        ...
        <div style={{ float: "left", marginLeft: "13%", width: "70%" }}>
          ...
          <FAQ
            ...
            answer="To apply online<ol><li>Persons with a disability can use https://www.swavlambancard.gov.in/website or register with the UDID web portal at <a href='https://www.swavlambancard.gov.in/pwd/application'>here</a></li><li>Using Enrolment Number/UDID Number and Date of Birth, log into the system and click “Apply online for Disability Certificate”. </li></ol>To apply offline, Fill out the application form given <a href='https://www.swavlambancard.gov.in/'>here</a>. After filling the application form with personal details, address details, disability details, employment details and identity details,  it should be submitted at CMO office or at nearest medical authority along with the required documents as mentioned below You can know about your nearest medical authority by visiting- <a href='https://www.swavlambancard.gov.in/findNearestMedicalAutority'>here</a> or can call DCPCR helpline number 9311551393."
          />
          <FAQ
